...
// This is the function that implements protocol logic
// it reads all the request and writes the response
static bool try_one_request(Conn *conn)
{
    ...
    memcpy(conn->wbuf, &res_len, 4);
    memcpy(conn->wbuf+4, res, res_len);
